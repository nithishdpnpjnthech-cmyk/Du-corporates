/*! @license DOMPurify 3.0.6 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.0.6/LICENSE */ ! function(e, t) {
    ...
    var V = function t() {
        ...
        const o = e => t(e);
        if (o.version = "3.0.6", o.removed = [], !n || !n.document || 9 !== n.document.nodeType) return o.isSupported = !1, o;
        let {
            document: r
        } = n;
        const a = r,
        ...
        let Ue = !0,
            ...
            Fe = {},
            He = null;
        const ze = b({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
        let Be = null;
        const We = b({}, ["audio", "video", "img", "source", "image", "track"]);
        let Ge = null;
        const Ye = b({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
        ...
        const ot = r.createElement("form"),
            ...
            it = function() {
                ...
                if (!nt || nt !== e) {
                    ...
                    } else void 0 === Q && (Q = K(G, c)), null !== Q && "string" == typeof ee && (ee = Q.createHTML(""));
                    i && i(e), nt = e
                }
            },
        ...
        const mt = function(e) {
            ...
            dt = function(e) {
                ...
                "application/xhtml+xml" === Je && Ke === Xe && (e = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e + "</body></html>");
                ...
                if (!he[n] || Ae[n]) {
                    ...
                    if (Ue && !He[n]) {
                        const t = J(e) || e.parentNode,
                            n = Z(e) || e.childNodes;
                        if (n && t) {
                            for (let o = n.length - 1; o >= 0; --o) t.insertBefore(V(n[o], !0), $(e))
                        }
                    }
                    return ft(e), !0
                }
                return e instanceof P && !mt(e) ? (ft(e), !0) : "noscript" !== n && "noembed" !== n && "noframes" !== n || !E(/<\/no(script|embed|frames)/i, e.innerHTML) ? (we && 3 === e.nodeType && (t = e.textContent, u([le, ce, se], (e => {
                    t = g(t, e, " ")
                })), e.textContent !== t && (f(o.removed, {
                    element: e.cloneNode()
                }), e.textContent = t)), yt("afterSanitizeElements", e, null), !1) : (ft(e), !0)
            },
            At = function(e, t, n) {
                ...
                else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== T(n, "data:") || !Be[e]) {
                    if (Se && !E(fe, g(n, pe, "")));
                    else if (n) return !1
                } else;
                return !0
            ...
            Nt = function(e) {
                ...
                for (; r--;) {
                    ...
                    if (At(p, s, f)) {
                        if (!Ie || "id" !== s && "name" !== s || (pt(a, e), f = Me + f), Q && "object" == typeof G && "function" == typeof G.getAttributeType)
                            if (l);
                            else switch (G.getAttributeType(p, s)) {
                                case "TrustedHTML":
                                    f = Q.createHTML(f);
                                    break;
            ...
            bt = function e(t) {
                let n = null;
                const o = ht(t);
                for (yt("beforeSanitizeShadowDOM", t, null); n = o.nextNode();) yt("uponSanitizeShadowNode", n, null), Et(n) || (n.content instanceof s && e(n.content), Nt(n));
        ...
        return o.sanitize = function(e) {
            ...
            } else if (e instanceof N) n = dt("\x3c!----\x3e"), r = n.ownerDocument.importNode(e, !0), 1 === r.nodeType && "BODY" === r.nodeName || "HTML" === r.nodeName ? n = r : n.appendChild(r);
            else {
            ...
            const c = ht(Pe ? e : n);
            for (; i = c.nextNode();) Et(i) || (i.content instanceof s && bt(i.content), Nt(i));
            if (Pe) return e;
            if (xe) {
                if (ke)
            ...
            return De && he["!doctype"] && n.ownerDocument && n.ownerDocument.doctype && n.ownerDocument.doctype.name && E(j, n.ownerDocument.doctype.name) && (m = "<!DOCTYPE " + n.ownerDocument.doctype.name + ">\n" + m), we && u([le, ce, se], (e => {
                m = g(m, e, " ")
