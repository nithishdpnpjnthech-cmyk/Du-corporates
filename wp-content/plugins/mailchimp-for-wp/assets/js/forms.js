(() => {
    var e = {
            2076: e => {
                ...
                function i(e, t, n) {
                    ...
                    if (o) {
                        var s = o[1],
                            a = +s;
                        isNaN(a) ? (e = e || {})[s] = i(e[s], t, n) : (e = e || [])[a] = i(e[a], t, n)
                    } else e[r] = i(e[r], t, n);
                    return e
                }
                ...
                e.exports = function(e, r) {
                    ...
                    for (var i = r.hash ? {} : "", a = r.serializer || (r.hash ? o : s), c = e && e.elements ? e.elements : [], l = Object.create(null), u = 0; u < c.length; ++u) {
                        var f = c[u];
                            ...
                            if ("select-multiple" !== f.type) i = a(i, d, h);
                                ...
                                for (var p = f.options, m = !1, g = 0; g < p.length; ++g) {
                                    var y = p[g],
                                        v = r.empty && !y.value,
                                        w = y.value || v;
                                    y.selected && w && (m = !0, i = r.hash && "[]" !== d.slice(d.length - 2) ? a(i, d + "[]", y.value) : a(i, d, y.value))
                                }!m && r.empty && (i = a(i, d, ""))
                            }
                        }
                    }
                    if (r.empty)
                        for (var d in l) l[d] || (i = a(i, d, ""));
                    return i
                }
            },
            5626: () => {
                function e(e) {
                    const t = !!e.getAttribute("data-show-if"),
                        ...
                        o = function(e, t) {
                            ...
                            for (let e = 0; e < r.length; e++)("radio" !== r[e].type && "checkbox" !== r[e].type || r[e].checked) && n.push(r[e].value);
                            return n
                        }(function(e) {
                            let t = e;
                            for (; t.parentElement;)
                    ...
                    let s = !1;
                    for (let e = 0; e < o.length && !s; e++) s = i.indexOf(o[e]) > -1 || i.indexOf("*") > -1 && o[e].length > 0;
                    e.style.display = t ? s ? "" : "none" : s ? "none" : "";
                    const a = e.querySelectorAll("input,select,textarea");
                    for (let e = 0; e < a.length; e++)(s || t) && a[e].getAttribute("data-was-required") && (a[e].required = !0, a[e].removeAttribute("data-was-required")), s && t || !a[e].required || (a[e].setAttribute("data-was-required", "true"), a[e].required = !1)
                }
                ...
                function n(t) {
                    if (!t.target || !t.target.form || t.target.form.className.indexOf("mc4wp-form") < 0) return;
            ...
            6564: e => {
                e.exports && (e.exports = function e(t, n, r) {
                    for (const i in n) {
                        ...
                        const o = i;
                        let s = n[i];
                        if (void 0 === s && (s = ""), null === s && (s = ""), void 0 !== r && (o = r + "[" + i + "]"), s.constructor === Array) o += "[]";
                        ...
                        switch (c) {
                            ...
                            case "radio":
                                    case "checkbox":
                                {
                                    ...
                                    for (let t = 0; t < a.length; t++) a[t].checked = e.indexOf(a[t].value) > -1
                                }
                                break;
                            case "select-multiple":
                                {
                                    const e = s.constructor === Array ? s : [s];
                                    for (let t = 0; t < a.options.length; t++) a.options[t].selected = e.indexOf(a.options[t].value) > -1
                                }
                                break;
                            case "select":
                                    case "select-one":
                        ...
                        switch (c) {
                            default: a.dispatchEvent(l);
                            break;
                            case "radio":
                                    case "checkbox":
                                    for (let e = 0; e < a.length; e++) a[e].checked && a[e].dispatchEvent(l)
                        }
                    }
                })
            },
            ...
            9685: (e, t, n) => {
                ...
                e.exports = {
                    ...
                    trigger: function(e, t) {
                        "submit" === e || e.indexOf(".submit") > 0 ? (o.emit(t[0].id + "." + e, t), o.emit(e, t)) : window.setTimeout(function() {
            ...
            9885: e => {
                ...
                t.prototype.emit = function(e, t) {
                    this.listeners[e] = this.listeners[e] ? ? [], this.listeners[e].forEach(e => e.apply(null, t))
    ...
    }), r.listeners && ([].forEach.call(r.listeners, function(e) {
        i.on(e.event, e.callback)
    }), delete r.listeners), r.forms = i, window.mc4wp = r
})();