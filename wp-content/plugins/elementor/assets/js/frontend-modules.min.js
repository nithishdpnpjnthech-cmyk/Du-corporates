    ...
    [941], {
        ...
        169: (e, t, r) => {
            ...
            var n = r(4762),
                ...
                b = e.exports = function(e, t, r) {
                    ...
                    var n = d(e);
                    return o(n, "source") || (n.source = v(_, "string" == typeof t ? t : "")), e
                };
        ...
        555: (e, t, r) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = void 0, r(4846), r(7458), r(9655);
            var n = function _interopRequireWildcard(e, t) {
            ...
            const i = ".e-admin-top-bar",
                s = ".e-admin-top-bar__bar-button",
                o = ".e-admin-top-bar__bar-button-title";
            t.default = class TopBarTracking {
                static init() {
                    this.waitForTopBar()
                }
                static waitForTopBar() {
                    ...
                    const t = new MutationObserver((e, t) => {
                        ...
                        r && (this.attachTopBarTracking(r), t.disconnect())
                    });
                    ...
                    new MutationObserver(e => {
                        e.forEach(e => {
                            "childList" === e.type && e.addedNodes.forEach(e => {
                                if (1 === e.nodeType)
                                    if (e.matches && e.matches(s)) e.addEventListener("click", e => {
                                        this.handleTopBarClick(e)
                                    });
                                    else {
                                        (e.querySelectorAll ? e.querySelectorAll(s) : []).forEach(e => {
                                            e.addEventListener("click", e => {
                                                this.handleTopBarClick(e)
                                            })
                                        })
                ...
                static handleTopBarClick(e) {
                    ...
                    n.default.trackNavClicked(r, null, n.NAV_AREAS.TOP_BAR)
                }
                static extractItemId(e) {
                    ...
                    if (i) return i;
                    const s = e.className.split(" ").filter(e => e && "e-admin-top-bar__bar-button" !== e);
        ...
        1265: (e, t, r) => {
            ...
            t.default = window.elementorModules = {
                ...
                appsEventTracking: {
                    AppsEventTracking: p.AppsEventTracking
                },
                wpDashboardTracking: {
                    WpDashboardTracking: h.default
                }
            }
        },
        1278: (e, t, r) => {
        ...
        1506: (e, t, r) => {
            ...
            e.exports = function(e, t, r) {
                var g, m, v, y, _, b, w, S = r && r.that,
                    ...
                    x = n(t, S),
                    stop = function(e) {
                        return g && p(g, "normal"), new Result(!0, e)
                    },
                    callFn = function(e) {
                        return E ? (s(e), T ? x(e[0], e[1], stop) : x(e[0], e[1])) : T ? x(e, stop) : x(e)
                    };
                if (k) g = e.iterator;
                else if (C) g = e;
                else {
                    ...
                    if (a(m)) {
                        for (v = 0, y = c(e); y > v; v++)
                            if ((_ = callFn(e[v])) && l(f, _)) return _;
                        return new Result(!1)
                    }
                    g = u(e, m)
                }
                for (b = k ? e.next : g.next; !(w = i(b, g)).done;) {
                    try {
                        _ = callFn(w.value)
                    } catch (e) {
                        p(g, "throw", e)
                    }
                    if ("object" == typeof _ && _ && l(f, _)) return _
                }
                return new Result(!1)
            }
        },
        ...
        3025: (e, t, r) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.DashboardUtils = void 0, r(4846), r(5568);
            t.DashboardUtils = {
                isElementorPage() {
                    const e = new URLSearchParams(window.location.search),
                        t = e.get("page");
                    if (t && (t.startsWith("elementor") || t.includes("elementor"))) return !0;
                    if ("elementor_library" === e.get("post_type")) return !0;
                    return document.body.className.split(" ").some(e => e.includes("elementor") && (e.includes("page") || e.includes("post-type")))
                }
            }
        },
        3145: (e, t, r) => {
        ...
        3617: (e, t, r) => {
            ...
            var n = r(8612),
                ...
                b = TypeError,
                w = i[y],
                S = m || !a(w) || w.prototype !== f || !d(function() {
                    w({})
                }),
                E = function Iterator() {
            ...
            p(f, _) || defineIteratorPrototypeAccessor(_, y), !S && p(f, v) && f[v] !== Object || defineIteratorPrototypeAccessor(v, E), E.prototype = f, n({
                global: !0,
                constructor: !0,
                forced: S
            }, {
        ...
        3827: (e, t, r) => {
            ...
            class WpDashboardTracking {
                ...
                static config = null;
                static canSendEvents = !1;
                static initialized = !1;
                static init() {
                    if (this.initialized) return;
                    this.sessionStartTime = Date.now(), this.lastActivityTime = Date.now(), this.sessionEnded = !1, this.navItemsVisited = new Set, this.config = elementorCommon ? .config || {};
                    const e = this.config.editor_events || {};
                    this.canSendEvents = e.can_send_events || !1, this.isEventsManagerAvailable() && (this.startSessionMonitoring(), this.attachActivityListeners(), this.initialized = !0)
                }
                ...
                static dispatchEvent(e, t = {}) {
                    if (this.canSendEvents && this.isEventsManagerAvailable()) try {
                        elementorCommon.eventsManager.dispatchEvent(e, t)
                    } catch (e) {
                        this.canSendEvents = !1
                    }
                }
                static updateActivity() {
                    this.lastActivityTime = Date.now(), this.sessionEnded = !1
                }
                static startSessionMonitoring() {
                    this.activityCheckInterval = setInterval(() => {
                        this.checkSessionTimeout()
                    }, 6e4), window.addEventListener("beforeunload", () => {
                        this.trackSessionEnd("page_unload")
                    }), document.addEventListener("visibilitychange", () => {
                        if (document.hidden) {
                            Date.now() - this.lastActivityTime > c && this.trackSessionEnd("tab_inactive")
                        }
                    })
                }
                static checkSessionTimeout() {
                    Date.now() - this.lastActivityTime > c && !this.sessionEnded && this.trackSessionEnd("timeout")
                }
                static attachActivityListeners() {
                    ["mousedown", "keydown", "scroll", "touchstart", "click"].forEach(e => {
                ...
                static trackNavClicked(e, t = null, r = l.LEFT_MENU) {
                    this.updateActivity(), this.navItemsVisited.add(e);
                    const n = {
                        wpdash_nav_item_id: e,
                        wpdash_nav_area: r
                    };
                    t && (n.wpdash_nav_item_root = t), this.dispatchEvent("wpdash_nav_clicked", n)
                }
                static trackScreenViewed(e, t = u.TAB) {
                    this.updateActivity();
                    const r = {
                        wpdash_screen_id: e,
                        wpdash_screen_type: t
                    };
                ...
                static destroy() {
                    this.activityCheckInterval && clearInterval(this.activityCheckInterval), this.initialized = !1
                }
            }
            t.default = WpDashboardTracking, window.addEventListener("elementor/admin/init", () => {
                WpDashboardTracking.init(), i.default.init(), s.default.init(), o.default.init(), a.default.init()
            })
        },
        3864: (e, t, r) => {
            "use strict";
        ...
        5454: (e, t, r) => {
            ...
            t.appsEventTrackingDispatch = (e, t) => {
                ...
                (() => {
                    ...
                    const t = e.split("/");
                    i.placement = t[0], i.event = t[1], Object.keys(s).length && (i.details = s)
                })(), $e.run(e, i)
            };
        ...
        6336: (e, t, r) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = void 0, r(4846), r(9655);
            var n = function _interopRequireWildcard(e, t) {
                if ("function" == typeof WeakMap) var r = new WeakMap,
                    n = new WeakMap;
                return function(e, t) {
            ...
            const i = "li#toplevel_page_elementor",
                s = "li#menu-posts-elementor_library",
                o = ".wp-submenu",
                a = ".wp-has-submenu";
            t.default = class NavigationTracking {
                static init() {
                    this.attachElementorMenuTracking(), this.attachTemplatesMenuTracking()
                }
                ...
                static attachMenuTracking(e, t) {
                    const r = e.querySelector("a.menu-top"),
                        n = e.querySelector(o);
                    if (r && r.addEventListener("click", e => {
                            this.handleTopLevelClick(e)
                        }), n) {
                        n.querySelectorAll("li a").forEach(e => {
                            e.addEventListener("click", e => {
                                this.handleSubmenuClick(e, t)
                            })
                        }), this.observeSubmenuChanges(n, t)
                    }
                }
                static observeSubmenuChanges(e, t) {
                    new MutationObserver(e => {
                        e.forEach(e => {
                            "childList" === e.type && e.addedNodes.forEach(e => {
                                if (1 === e.nodeType && "LI" === e.tagName) {
                ...
                static handleTopLevelClick(e) {
                    const t = e.currentTarget,
                        r = this.extractItemId(t),
                        i = this.determineNavArea(t);
                    n.default.trackNavClicked(r, null, i)
                }
                static handleSubmenuClick(e, t) {
                    const r = e.currentTarget,
                        i = this.extractItemId(r),
                        s = this.determineNavArea(r);
                    n.default.trackNavClicked(i, t, s)
                }
                static extractItemId(e) {
                    ...
                    if (r) {
                        const e = new URLSearchParams(r.split("?")[1] || ""),
                            t = e.get("page"),
                            n = e.get("post_type");
                        if (t) return t;
                        if (n) return n
                ...
                static determineNavArea(e) {
                    if (e.closest("li.menu-top")) {
                        if (e.closest(o)) {
                            return e.closest(a).classList.contains("wp-not-current-submenu") ? n.NAV_AREAS.HOVER_MENU : n.NAV_AREAS.SUBMENU
                        }
                        return n.NAV_AREAS.LEFT_MENU
                    }
                    return n.NAV_AREAS.LEFT_MENU
                }
            }
        ...
        7670: (e, t, r) => {
            ...
            var n = function _interopRequireWildcard(e, t) {
                ...
                i = r(3025);
            const s = ".nav-tab-wrapper",
                o = ".nav-tab-active",
                a = ".elementor-settings-form-page",
                c = ".elementor-settings-form-page.elementor-active";
            class ScreenViewTracking {
                static trackedScreens = new Set;
                static init() {
                    i.DashboardUtils.isElementorPage() && (this.trackInitialPageView(), this.attachTabChangeTracking())
                }
                static trackInitialPageView() {
                    ...
                    "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", run, {
                        once: !0
                    }) : run()
                }
                static getScreenData() {
                    ...
                    let l = "",
                        u = n.SCREEN_TYPES.APP_SCREEN;
                    l = t || (r || this.getScreenIdFromBody());
                    const d = document.querySelector(s),
                        p = document.querySelectorAll(a).length > 1;
                    if (d || p || i)
                        if (u = n.SCREEN_TYPES.TAB, i) {
                            l = `${l}-${i.replace(/^#(tab-)?/,"")}`
                        } else if (d) {
                        ...
                        if (e) {
                            ...
                            if (t) l = `${l}-${this.sanitizeScreenId(t)}`;
                ...
                static getScreenIdFromBody() {
                    ...
                    for (const t of e)
                        if (t.startsWith("elementor") && (t.includes("page") || t.includes("post-type"))) return t;
                ...
                static attachTabChangeTracking() {
                    this.attachNavTabTracking(), this.attachHashChangeTracking(), this.attachSettingsTabTracking()
                }
                static attachNavTabTracking() {
                    ...
                    new MutationObserver(e => {
                        for (const t of e) {
                            ...
                            if ("attributes" === t.type && "class" === t.attributeName) {
                                const e = t.target;
                                if (e && e.classList && e.classList.contains("nav-tab")) {
                                    const e = this.getScreenData();
                                    e && this.trackScreen(e.screenId, e.screenType);
                                    break
                                }
                ...
                static trackScreen(e, t = n.SCREEN_TYPES.APP_SCREEN) {
                    const r = `${e}-${t}`;
                    this.trackedScreens.has(r) || (this.trackedScreens.add(r), n.default.trackScreenViewed(e, t))
                }
            }
        ...
        8064: (e, t, r) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = void 0, r(4846), r(7458);
            var n = function _interopRequireWildcard(e, t) {
                    if ("function" == typeof WeakMap) var r = new WeakMap,
                        n = new WeakMap;
                    return function(e, t) {
            ...
            t.default = class ActionControlTracking {
                static init() {
                    i.DashboardUtils.isElementorPage() && this.attachDelegatedHandlers()
                }
                ...
                static attachDelegatedHandlers() {
                    document.addEventListener("click", e => {
                        const t = e.target && 1 === e.target.nodeType ? e.target : e.target ? .parentElement;
                        if (!t) return;
                        const r = t.closest('button, input[type="submit"], input[type="button"], .button, .e-btn');
                        if (r && !this.isExcludedElement(r)) return void this.trackControl(r, n.CONTROL_TYPES.BUTTON);
                        const i = t.closest("a");
                        !i || this.isExcludedElement(i) || this.isNavigationLink(i) || this.trackControl(i, n.CONTROL_TYPES.LINK)
                    }, {
                        capture: !1
                    }), document.addEventListener("change", e => {
                        const t = e.target && 1 === e.target.nodeType ? e.target : e.target ? .parentElement;
                        if (!t) return;
                        const r = t.closest('.elementor-control-type-switcher input, [role="switch"], .toggle-control input');
                        if (r && !this.isExcludedElement(r)) return void this.trackControl(r, n.CONTROL_TYPES.TOGGLE);
                        const i = t.closest('input[type="checkbox"]');
                        if (i && !this.isExcludedElement(i)) return void this.trackControl(i, n.CONTROL_TYPES.CHECKBOX);
                        const s = t.closest('input[type="radio"]');
                        if (s && !this.isExcludedElement(s)) return void this.trackControl(s, n.CONTROL_TYPES.RADIO);
                        const o = t.closest("select");
                        o && !this.isExcludedElement(o) && this.trackControl(o, n.CONTROL_TYPES.SELECT)
                    })
                }
                ...
                static trackControl(e, t) {
                    const r = this.extractControlData(e, t);
                    n.default.trackActionControl(r, t)
                }
                static extractControlData(e, t) {
                    const r = {},
                        i = e.getAttribute("id");
                    i && (r.id = i);
                    ...
                    s && (r.name = s);
                    let o = "";
                    if (n.CONTROL_TYPES.BUTTON === t) o = e.value || e.textContent.trim() || e.getAttribute("aria-label");
                    else if (n.CONTROL_TYPES.LINK === t) o = e.textContent.trim() || e.getAttribute("aria-label") || e.getAttribute("title");
                    else if (n.CONTROL_TYPES.SELECT === t) {
                        const t = e.options[e.selectedIndex];
                        o = t ? t.textContent.trim() : ""
                    } else if (n.CONTROL_TYPES.CHECKBOX === t || n.CONTROL_TYPES.TOGGLE === t || n.CONTROL_TYPES.RADIO === t) {
                        const t = e.labels ? e.labels[0] : null;
                        o = t ? t.textContent.trim() : "", r.checked = e.checked
                    }
                    o && (r.text = o);
                    const a = e.className;
                    if (a && "string" == typeof a) {
                        const e = a.split(" ").filter(e => e && !e.startsWith("elementor-control-") && !e.startsWith("wp-")).slice(0, 3);
                        e.length > 0 && (r.classes = e.join(" "))
                    }
                    if (n.CONTROL_TYPES.LINK === t) {
                        const t = e.getAttribute("href");
                        t && !t.startsWith("#") && (r.href = t)
                    }
                    return r
                }
            }
        ...
        8660: (e, t, r) => {
            ...
            s(w, f, "Iterator Helper"), e.exports = function(e, t, r) {
                var n = function Iterator(n, i) {
                    i ? (i.iterator = n.iterator, i.next = n.next) : i = n, i.type = t ? m : g, i.returnHandlerResult = !!r, i.nextHandler = e, i.counter = 0, i.done = !1, _(this, i)
                };
